...
class EnableAlarmNotificationPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      new _EnableAlarmNotificationPageState();
}

class _EnableAlarmNotificationPageState
    extends State<EnableAlarmNotificationPage> {
  ...
  void addAlarms() {
    ...
    alarms
        .add(new NotificationTypeModel(type: "geofenceEnter", enabled: false));
    alarms.add(new NotificationTypeModel(type: "geofenceExit", enabled: false));
    alarms
        .add(new NotificationTypeModel(type: "gpsAntennaCut", enabled: false));
    ...
    alarms.add(
        new NotificationTypeModel(type: "hardAcceleration", enabled: false));
    alarms.add(new NotificationTypeModel(type: "hardBraking", enabled: false));
    alarms
        .add(new NotificationTypeModel(type: "hardCornering", enabled: false));
    alarms.add(new NotificationTypeModel(type: "laneChange", enabled: false));
    alarms
        .add(new NotificationTypeModel(type: "fatigueDriving", enabled: false));
    alarms.add(new NotificationTypeModel(type: "powerCut", enabled: false));
    alarms
        .add(new NotificationTypeModel(type: "powerRestored", enabled: false));
            ...
            if (element.type == "alarm") {
              ...
              if (element.attributes!["alarms"] != null) {
                selectedNotifications =
                    element.attributes!["alarms"].split(",");
              }
  ...
  void deleteNotification(String notify) {
    Traccar.deleteNotifications(notify).then((value) => {setState(() {})});
  }
