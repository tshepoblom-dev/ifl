...
import 'package:gpspro/api/model/maintenance_post.dart';
...
class _MaintenanceState extends State<MaintenancePage> {
  ...
  void getMaintenance() {
    Traccar.getMaintenance().then(
        (value) => {_postsController.add(1), maintenanceList.addAll(value!)});
  }
                        ...
                        children: <Widget>[
                          ...
                          new Container(
                            child: new TextField(
                              ...
                              decoration:
                                  new InputDecoration(labelText: ('name').tr),
                            ),
                          ),
                          new Container(
                            child: new TextField(
                              ...
                              decoration:
                                  new InputDecoration(labelText: ('type').tr),
                            ),
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
