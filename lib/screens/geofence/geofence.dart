...
class GeofencePage extends StatefulWidget {
  ...
  final int deviceId;
  final String name;
  GeofencePage(this.fenceModel, this.deviceId, this.name);
  @override
...
class _GeofencePageState extends State<GeofencePage> {
  ...
  void getFences() async {
    ...
    _timer = new Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      _timer.cancel();
      String fence = widget.fenceModel.area!
          .replaceAll("CIRCLE (", "")
          .replaceAll(",", "")
          .replaceAll(")", "");
      ...
      setState(() {
        _myPainterToBitmap(widget.fenceModel.name!, "marker")
            .then((BitmapDescriptor bitmapDescriptor) {
          _markers.add(Marker(
            markerId: MarkerId(widget.fenceModel.id.toString()),
            position: new LatLng(
            ...
            onTap: () {
              ...
              deleteFenceId = widget.fenceModel.id!;
            },
          ));
        });
      });
      _updateCircle(
          widget.fenceModel.id!, fenceSplit[0], fenceSplit[1], fenceSplit[2]);
  ...
  void deleteFence() {
    _showProgress(true);
    Traccar.deletePermission(widget.deviceId, widget.fenceModel.id)
        .then((value) => {
