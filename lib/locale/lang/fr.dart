const Map<String, String> fr_FR = {
  ...
  "positionSingle": "Rapport de position unique",
  "positionPeriodic": "Périodicité du rapport de position",
  "positionStop": "Arrêt du rapport de position",
  "engineStop": "Arrêt moteur",
  "engineResume": "Démarrage moteur",
  "alarmArm": "Activer l'alarme",
  "alarmDisarm": "Désactiver l'alarme",
  "setTimezone": "Régler le fuseau horaire",
  "requestPhoto": "Demander une photo",
  "powerOff": "Eteindre l'appareil",
  "rebootDevice": "Redémarrer l'appareil",
  "sendSms": "Envoyer un SMS",
  "sendUssd": "Envoyer un USSD",
  "sosNumber": "Régler le n° SOS",
  "silenceTime": "Définir le temps de silence",
  "setPhonebook": "Définir l'annuaire",
  "voiceMessage": "Message vocal",
  "outputControl": "Contrôle de la sortie",
  "voiceMonitoring": "Moniteur vocal",
  "setAgps": "Fixer l'AGPS",
  "cetIndicator": "Définir l'indicateur",
  "configuration": "Configuration",
  "getVersion": "Acquérir la version",
  "firmwareUpdate": "Mettre à jour le firmware",
  "setConnection": "Fixer la connexion",
  "setOdometer": "Fixer l'odomètre",
  "getModemStatus": "Acquérir le statut du modem",
  "getDeviceStatus": "Acquérir le statut du périphérique",
  "modePowerSaving": "Modifier la sauvegarde de courant",
  "modeDeepSleep": "Modifier le sommeil profond",
  ...
  "deviceOnline": "Statut: en ligne",
  "deviceUnknown": "Statut: inconnu",
  "deviceOffline": "Statut: hors ligne",
  "deviceMoving": "Appareil en mouvement",
  "deviceStopped": "Appareil arrêté",
  "deviceOverspeed": "Vitesse limite dépassée",
  "deviceFuelDrop": "Perte de carburant",
  "commandResult": "Résultat de la commande",
  "geofenceEnter": "Entrée dans le périmètre virtuel",
  "geofenceExit": "Sortie du périmètre virtuel",
  "ignitionOn": "Contact mis",
  "ignitionOff": "Contact coupé",
  "maintenance": "Entretien requis",
  "textMessage": "Message textuel reçu",
  ...
  "vibration": "Vibration",
  "movement": "Mouvement",
  "lowspeed": "Basse vitesse",
  "overspeed": "Vitesse trop haute",
  "fallDown": "Chute",
  "lowPower": "Tension basse",
  ...
  "tow": "Remorquage",
  "idle": "Au repos",
  "highRpm": "Tours par minute élevés",
  "hardAcceleration": "Accélération brusque",
  "hardBraking": "Freinage brusque",
  "hardCornering": "Virage sec",
  "laneChange": "Changement de bande",
  "fatigueDriving": "Conduite en état de fatigue",
  "powerCut": "Courant coupé",
  "powerRestored": "Courant restauré",
  "jamming": "Brouillage",
  ...
  "motorcycle": "Moto",
  "offroad": "Véhicule tout terrains",
  "person": "Personne",
  "pickup": "Pickup",
  "plane": "Avion",
  "ship": "Bateau",
  ...
  "vdop": "Dilution de précision horizontale",
  "pdop": "Dilution de précision de position",
  "sat": "Satellites",
  "satVisible": "Satellites visibles",
  "rssi": "RSSI",
  "gps": "GPS",
  "roaming": "Itinérance",
  "event": "Évènement",
  ...
  "status": "Statut",
  "odometer": "Odomètre",
  "serviceOdometer": "Odomètre d'entretien",
  "tripOdometer": "Odomètre de voyage",
  "hours": "Heures",
  "steps": "Etapes",
  "input": "Entrée de données",
  "output": "Sortie de données",
  "batteryLevel": "Niveau de batterie",
  "fuelConsumption": "Consommation de carburant",
  "rfid": "RFID",
  "versionFw": "Version du micrologiciel",
  "versionHw": "Version du matériel",
  "ignition": "Allumage",
  "flags": "Drapeau",
  "charge": "Charge",
  "ip": "IP",
  ...
  "deviceTemp": "Température de l'appareil",
  "operator": "Opérateur",
  "command": "Commande",
  "blocked": "Bloqué",
  "dtcs": "Code erreur",
  "obdSpeed": "Vitesse OBD",
  "obdOdometer": "Odomètre OBD",
  "driverUniqueId": "ID unique du pilote",
  "mage": "Image",
  "audio": "Audio",
  ...
  "failed": "Échoué",
  "type": "Type",
  "reportDashboard": "Tableau de bord du rapport",
  "showingAllDevices": "Affichage de tous les appareils",
  ...
  "diablePopupNotification": "Désactiver les notifications contextuelles",
  ...
  "on": "Mis",
  "off": "Coupé",
  "fuelCutOff": "Coupure de carburant",
  "distanceLength": "Distance Longueur",
  "addGeofence": "Ajouter Geofence",
  "fenceName": "Nom de la clôture",
  "newFence": "Nouvelle clôture",
  "tapToAddFence": "Appuyez n'importe où sur la carte pour ajouter une clôture",
  "fenceDeleted": "Clôture supprimée",
  "accountExpired": "Compte expiré",
  "enterFenceName": "Entrez le nom de la clôture",
  "noFence": "Aucune clôture attribuée",
  "fenceAddedSuccessfully": "Clôture ajoutée avec succès",
  ...
  "disableTitle": "Supprimer le titre du marqueur",
  "map": "Map",
